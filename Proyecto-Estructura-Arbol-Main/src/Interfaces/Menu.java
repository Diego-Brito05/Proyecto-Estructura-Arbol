...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BuscarAntepasados.setEnabled(false);
        BuscarAntepasados.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BuscarAntepasadosActionPerformed(evt);
            }
        });
        jPanel1.add(BuscarAntepasados, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 200, -1, 30));
        ...
        jLabel2.setText("Funcion no disponible (da error)");
        ...
        jLabel11.setText("Escriba el nombre de la persona");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 150, -1, -1));
    ...
    */
    ...
    private void BuscarAntepasadosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarAntepasadosActionPerformed
        ...
        if (ante== null || getHashtable() == null){
            JOptionPane.showMessageDialog(this, "No se encontro a la persona.", 
            "Error", JOptionPane.ERROR_MESSAGE);
        }else{
            int indice= getHashtable().buscarIndice(ante);
            if (indice!= -1){
                ...
                while(actual != null){
                    ...
                    String NumeralP = P.getNumeral();
                    info = info + contador +"- " + "Nombre: " + nombreP + "; Numeral" + NumeralP + "; Mote: " + MoteP + "; Hijo de: " + PadreP + "\n";
                ...
                if(esNumerico(respuesta)){
                    ...
                    if (actual != null){
                        ...
                        while(!per.getPadre().equalsIgnoreCase("[Unknown]")){
                            String padrePer= per.getPadre();
                            Personas.agregar(per);
                            per = (this.arbol.buscarNodoPorPadre(this.arbol, padrePer)).getValor();
                               
                        }
                        if(Personas.getCabeza()!=null){
                            Arbol Arboltemp = new Arbol(null);
                            Arboltemp=(Arbol.crearArbolDesdeLista(Personas));
                            Graph Antecesores = new MultiGraph("Antecesores");
                            System.setProperty("org.graphstream.ui", "swing");
                            System.setProperty("gs.ui.renderer", "org.graphstream.ui.j2dviewer.J2DGraphRenderer");
                            setFamilia(Antecesores);
                            agregarPersonasAlGrafo(Arboltemp,Antecesores);
                            crearRelaciones(Antecesores);
                            Antecesores.setAttribute("ui.layout", "FruchtermanReingold");
    ...
    private void BinfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BinfActionPerformed
        String NombrePersona = infop.getText();
        if (NombrePersona== null || getHashtable() == null){
            JOptionPane.showMessageDialog(this, "No se encontro a la persona.", 
            "Error", JOptionPane.ERROR_MESSAGE);
        }else{
            ...
            if (indice!= -1){
                ...
                NodoPersona actual= lPersonas.getCabeza();
                int contador = 1;
                String info = "Informacion de todos los " + NombrePersona + "\n" + "\n";
                while(actual != null){
                    Persona P= actual.getPersona();
                    String nombreP = P.getNombre();
                    String MoteP = P.getMote();
                    ...
                    String NumeralP = P.getNumeral();
                    String OjosP = P.getOjos();
                    String PeloP = P.getPelo();
                    info = info + contador +"- " + "Nombre: " + nombreP + "; Numeral: " + NumeralP + "; Mote: " + MoteP + "; Hijo de: " + PadreP + "; Titulo: " +  TituloP + "; Color de Ojos: " + OjosP + "; Dolor de pelo: " + PeloP + "\n" ;
                    actual = actual.siguiente;
                    contador ++;
                }
